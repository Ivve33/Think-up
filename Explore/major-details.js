...
// ── صور التخصصات من assets ──
const majorImages = {
    'computer-science':        './assets/computer-science.jpg',
    'software-engineering':    './assets/software-engineering.jpg',
    'computer-engineering':    './assets/computer-engineering.jpg',
    'data-science':            './assets/data-science.jpg',
    'cybersecurity':           './assets/cybersecurity.jpg',
    'artificial-intelligence': './assets/artificial-intelligence.jpg',
};
    ...
    try {
        ...
        if (collegeSnap.exists()) {
            ...
            if (icon.startsWith('http')) {
                collegeIconEl.innerHTML = `<img src="${icon}" alt="${data.name}">`;
            } else {
        ...
        majorsGrid.innerHTML = `<p style="color:red; grid-column:1/-1;">Error loading data.</p>`;
    }
}
...
async function fetchMajors() {
    try {
        ...
        allMajors.sort((a, b) => (a.order || 0) - (b.order || 0));// makink sure to sort majors and SWE is always first
        renderMajors(allMajors);

    } catch (err) {
        console.error('Fetch majors error:', err);
        majorsGrid.innerHTML = `<p style="color:red; grid-column:1/-1;">Error loading majors.</p>`;
    }
}
